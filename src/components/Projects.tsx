    ...
    roles: [
      {
        ...
        description: [
          ...
          "Deployed and maintained production applications on AWS (EC2, S3, Lambda) and Dockerized environments with CI/CD pipelines via GitHub Actions and Jenkins.",
          "Optimized backend performance using Prisma ORM and Redis caching, improving response times by 40%.",
          "Collaborated in Agile sprints, handled version control via Git/GitHub, and ensured high code quality.",
        ],
        achievements: [
          "Improved system performance by ~38% through backend service refactoring, query optimization, and caching implementation.",
          "Delivered multiple full-stack web solutions achieving over 95% client satisfaction.",
      ...
      },
      {
        ...
        description: [
          "Completed an intensive full-stack development program covering modern JavaScript frameworks and backend fundamentals.",
          "Developed internal mini-projects using React.js, Node.js, Express.js, and MySQL for practical learning.",
          "Built responsive interfaces and enhanced UI/UX using HTML5, CSS3, JavaScript, and Figma prototypes.",
          "Learned REST API integration, JSON data handling, and basic Docker and AWS deployments.",
          "Collaborated in Agile project cycles and participated in peer code reviews using Git and GitHub.",
        ],
        achievements: [
          ...
          "Built and showcased 3 internal applications demonstrating complete CRUD and API workflows.",
        ],
      },
    ],
    technologies: [
